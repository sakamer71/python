...
def edmunds_get_photos(style_id):
    #f = open('data/styles/{}_details.txt'.format(style_id), 'w+')
    with open('data/styles/{}_photos.txt'.format(style_id), 'wb') as handle:
        url = 'https://api.edmunds.com/v1/api/vehiclephoto/service/findphotosbystyleid?styleId={}&fmt=json&api_key=b34wypjmb2fjf85asccqrv3z'.format(style_id)
